		...
		<div class="shop-iphone--item">
			...
			dataItems[item].nameItem
			 ...
			 data-image="${
				...
				}" class="add-to-cart typo-callout text-uppercase btn btnPurple w-100">Add to
							cart</a></div>
		            <div class="col-6"><a href="#" class="btn btn-outline-danger w-100 mt-2 typo-callout text-uppercase">More</a></div>
		            </div>
			</div>
		</div>`;
