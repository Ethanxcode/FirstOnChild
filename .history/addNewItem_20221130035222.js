...
function handleCreaterForm() {
	...
	createBtn.onclick = function () {
		...
		var status = document.querySelector('input[name="price"]').value;
		var brand = document.querySelector('input[name="price"]').value;
		var sold = document.querySelector('input[name="price"]').value;
		var category = document.querySelector('input[name="price"]').value;
		var image = document.querySelector('input[name="price"]').value;
