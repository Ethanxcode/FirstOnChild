...
var shoppingCart = (function () {
	...
	obj.finalCart = () => {
		...
		return $('.final-cart').html(Number(finalCart.toFixed(2)));
	};
	...
	// 				console.log('x');
	// 			} else if (choice === 2) {
	// 				finalCart = totalCart() + 100;
	// 			} else if (choice === 3) {
	// 				finalCart = totalCart() + 50;
	// 			}
	// 			return Number(finalCart.toFixed(2));
	// 		});
	// 	}
	// };
	// cart : Array
...
function displayCart() {
	...
	for (var i in cartArray) {
		...
		// 	'<td>' +
		// 	'<div class="row mb-4 d-flex justify-content-between align-items-center">' +
		// 	'<div class="col-3"> <img style="height:90px;" src="' +
		// 	cartArray[i].image +
		// 	'" class="img-fluid rounded-3" alt="Cotton T-shirt"></div>' +
		// 	'<div class="col-4"><h6 class="text-muted text-uppercase">' +
		// 	cartArray[i].id +
		// 	'</h6><h6 class="text-black mb-0">' +
		// 	cartArray[i].name +
		// 	'</h6>' +
		// 	'</div>' +
		// 	'<h6 class="col-4 text-black mb-0">' +
		// 	formatter.format(cartArray[i].price) +
		// 	'</h6>' +
		// 	'<div class="col-md-1 col-lg-1 col-xl-1 text-end">' +
		// 	'<button class="delete-item btn btn-danger" data-id="' +
