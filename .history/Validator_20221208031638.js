...
function Validator(options) {
	...
	if (formElement) {
		...
		formElement.onsubmit = function (e) {
			...
			var formSubmitElement = document.querySelector('.formSubmit');
			console.log(formSubmitElement);
			if (isFormValid) {
				formSubmitElement.setAttribute('disabled', '');
			} else {
				formSubmitElement.removeAttribute();
			}
